...
public class FuelStationIT {
    @Autowired
    private MockMvc mockMvc;

    @Test
    void canGetAllFuelStations() throws Exception {

        // when
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/automate_api/v1/fuel-stations")
