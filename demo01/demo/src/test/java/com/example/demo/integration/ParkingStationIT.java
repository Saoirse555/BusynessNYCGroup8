...
public class ParkingStationIT {
    @Autowired
    private MockMvc mockMvc;

    @Test
    void canGetAllParkingStation() throws Exception {

        // when
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/automate_api/v1/parkingstations")
