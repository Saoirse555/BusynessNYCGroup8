...
public class ParkingStationNewIT {
    @Autowired
    private MockMvc mockMvc;

    @Test
    void canGetAllParkingStationNew() throws Exception {

        // when
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.get("/automate_api/v1/parking_stations_new")
